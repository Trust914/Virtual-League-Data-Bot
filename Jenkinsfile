pipeline {
    ...
    environment {
        ...
        lambdaFunctionArn = 'arn:aws:lambda:us-east-1:869704209971:function:League_project'
    }
            ...
            steps {
                script {
                    withAWS(region: "us-east-1", credentials: 'AWS_CREDENTIALS') {
                        sh "/usr/local/bin/aws lambda update-function-code --function-name '${lambdaFunctionArn}' --image-uri '${appRegistry}:$BUILD_NUMBER'"
